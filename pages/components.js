...
export const Components = () => {
  return (
    <div>
      ...
      <p>
        This showroom was bootstrapped with iJS starter project{' '}
        <a href="https://github.com/ijsto/istyled-nextjs">iStyled-Next.js</a>
      </p>
      <p>And comes with some free components.</p>
      <h2>{'<Card />'}</h2>
